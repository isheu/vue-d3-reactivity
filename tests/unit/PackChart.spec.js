...
describe('PackChart.vue', () => {
  test('calculates the canvas content dimensions based on padding', () => {
    const wrapper = shallowMount(PackChart, {
      propsData: { data: sampleData, height: 400, width: 500, padding: 10 }
    })
    expect(wrapper.vm.contentWidth).toEqual(480)
  })
})
